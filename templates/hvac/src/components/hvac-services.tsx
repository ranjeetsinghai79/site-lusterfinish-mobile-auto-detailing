              ...
              >
                ...
                >
                  <img
                    ...
                    style={{ opacity: 0.08, filter: "saturate(0.3) brightness(0.6)", transition: "opacity 0.4s ease" }}
                  />
                  <div
                    className="absolute inset-0"
                    style={{ background: "linear-gradient(180deg, rgba(14,28,42,0.92) 0%, rgba(14,28,42,0.85) 100%)" }}
                  />
                </div>
