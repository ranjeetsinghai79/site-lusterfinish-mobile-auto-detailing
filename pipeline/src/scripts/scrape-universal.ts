...
const TAB_CONFIGS: TabConfig[] = [
  ...
  {
    tab:          'MEDSPAS',
    niches:       ['medspa-usa', 'botox-clinic', 'aesthetic-clinic', 'cosmetic-dermatology', 'laser-clinic'],
    cities:       US_CITIES,
    noWebsiteOnly: false,
    tier:         'tier2',
  },
  ...
  },
  {
    ...
    niches:       ['financial-advisor', 'insurance-agent', 'life-insurance', 'tax-advisor', 'mortgage-broker'],
    cities:       US_CITIES,
    noWebsiteOnly: false,
    tier:         'tier2',
  },
